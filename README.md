...
| [SSS EnvVar & ConnRef Matrix](tools/envvar-matrix/README.md) — env vars and connection references across environments, copy values, merge duplicate and delete unused connection references across all flows, solution fit check, deploymentSettings.json import/export | `@simplesmoothsafe/pptb-envvar-matrix` | v1.2.0 (unreleased) |
