...
| [SSS Dependency Cleaner](tools/dependency-cleaner/README.md) — why does my solution depend on msdyn_*: find the component, convert tables to shells, strip msdyn columns from forms and views, with backup and restore | `@simplesmoothsafe/pptb-dependency-cleaner` | v1.0.0 |
