...
| [SSS EnvVar & ConnRef Matrix](tools/envvar-matrix/README.md) — env vars and connection references across environments, copy values, merge duplicate and delete unused connection references across all flows, bind connection references (settings file or Power Platform API picker), solution fit check, turn on flows after import, deploymentSettings.json import/export | `@simplesmoothsafe/pptb-envvar-matrix` | v1.4.1 (unreleased; npm: 1.4.0) |
