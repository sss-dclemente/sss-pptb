...
| [SSS EnvVar & ConnRef Matrix](tools/envvar-matrix/README.md) — env vars and connection references across environments, copy values, merge duplicate connection references across all flows, deploymentSettings.json | `@simplesmoothsafe/pptb-envvar-matrix` | v1.1.0 (unreleased) |
